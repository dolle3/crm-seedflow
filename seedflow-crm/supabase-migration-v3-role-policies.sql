-- ============================================================
-- Seedflow CRM - Migration v3: Role-based write permissions
-- Admin: full CRUD
-- Manager: CRUD on leads only
-- Sales: read-only
-- ============================================================
...
create policy "Leads updatable by admins and managers"
  on public.leads for update to authenticated
  using (public.current_user_role() in ('admin', 'manager'))
  with check (public.current_user_role() in ('admin', 'manager'));

create policy "Leads deletable by admins and managers"
...
create policy "Deals insertable by admins"
  on public.deals for insert to authenticated
  with check (public.current_user_role() = 'admin');

create policy "Deals updatable by admins"
...
create policy "Deal notes insertable by admins"
...
create policy "Activities insertable by admins"
  on public.activities for insert to authenticated
  with check (public.current_user_role() = 'admin');

create policy "Activities updatable by admins"
...
create policy "Tasks insertable by admins"
  on public.tasks for insert to authenticated
  with check (public.current_user_role() = 'admin');

create policy "Tasks updatable by admins"
